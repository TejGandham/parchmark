...
class TestUserSchemas:
    ...
    class TestUserCreate:
        ...
        def test_user_create_json_serialization(self):
            ...
            assert json_data == {"username": "testuser", "password": "testpass123"}
...
class TestNoteSchemas:
    ...
    class TestNoteCreate:
        ...
        def test_note_create_valid(self):
            ...
            note = NoteCreate(title="Test Note", content="# Test Note\n\nThis is test content.")
    ...
    class TestNoteUpdate:
        ...
        def test_note_update_both_fields(self):
            ...
            update = NoteUpdate(title="Updated Title", content="Updated content")
    ...
    class TestNoteResponse:
        ...
        def test_note_response_valid(self):
            ...
            # F19: accessCount and lastAccessedAt are removed from NoteResponse.
        ...
        def test_note_response_datetime_formatting(self):
            ...
            response = NoteResponse(
                id="note-123", title="Test Note", content="Content", createdAt=iso_datetime, updatedAt=iso_datetime
            )
...
class TestResponseSchemas:
    ...
    class TestDeleteResponse:
        ...
        def test_delete_response_valid(self):
            ...
            response = DeleteResponse(message="Note deleted successfully", deleted_id="note-123")
...
class TestSchemaIntegration:
    ...
    def test_note_create_to_response_conversion(self):
        ...
        note_create = NoteCreate(title="Test Note", content="# Test Note\n\nContent")
