...
class TestCreateTables:
    ...
    def test_create_tables_with_existing_data(self, test_db_engine, test_db_session):
        ...
        with patch('app.database.init_db.engine', test_db_engine):
            ...
            existing_user = test_db_session.query(User).filter(
...
class TestInitDatabase:
    ...
    def test_init_database_success_no_seeding_needed(
        self, mock_seed, mock_check_status, mock_create_tables
    ):
    ...
    @patch('app.database.init_db.check_seeding_status')
    @patch('app.database.init_db.seed_database')
    def test_init_database_success_with_seeding(
        self, mock_seed, mock_check_status, mock_create_tables
    ):
    ...
    @patch('app.database.init_db.check_seeding_status')
    @patch('app.database.init_db.seed_database')
    def test_init_database_seeding_failure(
        self, mock_seed, mock_check_status, mock_create_tables
    ):
    ...
    @patch('app.database.init_db.create_tables')
    @patch('app.database.init_db.check_seeding_status')
    def test_init_database_check_seeding_exception(
        self, mock_check_status, mock_create_tables
    ):
    ...
    @patch('app.database.init_db.check_seeding_status')
    @patch('app.database.init_db.seed_database')
    def test_init_database_seed_exception(
        self, mock_seed, mock_check_status, mock_create_tables
    ):
    ...
    @patch('app.database.init_db.check_seeding_status')
    @patch('app.database.init_db.seed_database')
    def test_init_database_output_messages(
        self, mock_seed, mock_check_status, mock_create_tables, mock_print
    ):
    ...
    @patch('app.database.init_db.create_tables')
    @patch('app.database.init_db.check_seeding_status')
    def test_init_database_already_seeded_message(
        self, mock_check_status, mock_create_tables, mock_print
    ):
...
class TestDatabaseInitializationEdgeCases:
    ...
    @patch('app.database.init_db.create_tables')
    @patch('app.database.init_db.check_seeding_status')
    def test_init_database_seeding_status_invalid_format(
        self, mock_check_status, mock_create_tables
    ):
