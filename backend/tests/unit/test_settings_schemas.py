...
class TestUserInfoResponse:
    ...
    def test_valid_user_info_response(self):
        ...
        data = {"username": "testuser", "created_at": "2025-01-01T00:00:00Z", "notes_count": 5}
    ...
    def test_notes_count_validation(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            UserInfoResponse(username="testuser", created_at="2025-01-01T00:00:00Z")
    ...
    def test_missing_required_fields(self):
        ...
        # Missing username
        with pytest.raises(ValidationError) as exc_info:
            UserInfoResponse(created_at="2025-01-01T00:00:00Z", notes_count=5)

        assert "username" in str(exc_info.value)

        # Missing created_at
        with pytest.raises(ValidationError) as exc_info:
            UserInfoResponse(username="testuser", notes_count=5)
    ...
    def test_notes_count_must_be_integer(self):
        ...
        response = UserInfoResponse(username="testuser", created_at="2025-01-01T00:00:00Z", notes_count="5")
        assert response.notes_count == 5

        # Invalid string should fail
        with pytest.raises(ValidationError):
            UserInfoResponse(username="testuser", created_at="2025-01-01T00:00:00Z", notes_count="invalid")
