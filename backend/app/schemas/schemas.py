...
class UserCreate(BaseModel):
    ...
    username: str = Field(..., min_length=1, max_length=50, description="Username for the new user")
...
class NoteUpdate(BaseModel):
    ...
    content: Optional[str] = Field(None, description="Updated markdown content of the note")
...
class ValidationErrorResponse(BaseModel):
    ...
    errors: Optional[list] = Field(None, description="List of specific validation errors")
