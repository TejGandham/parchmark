...
describe('useStoreRouterSync', () => {
  ...
  it('should navigate to first note when at /notes route with notes available', () => {
    ...
    (require('react-router-dom').useLocation as jest.Mock).mockReturnValue({ pathname: '/notes' });
  ...
  it('should navigate to not-found if noteId in URL doesnt exist', () => {
    ...
    (require('react-router-dom').useParams as jest.Mock).mockReturnValue({ noteId: 'non-existent' });
  ...
  it('should update store when valid noteId is in URL', () => {
    ...
    (require('react-router-dom').useParams as jest.Mock).mockReturnValue({ noteId: 'note-2' });
  ...
  it('should pass through updateNote action', () => {
    ...
    expect(mockNotesStore.actions.updateNote).toHaveBeenCalledWith('note-1', 'New content');
  });
  ...
  it('should pass through setEditedContent action', () => {
    ...
    expect(mockNotesStore.actions.setEditedContent).toHaveBeenCalledWith('Edited content');
  });
  ...
  it('should handle empty notes array correctly', () => {
    ...
    // Mock location to trigger the navigation effect
    (require('react-router-dom').useLocation as jest.Mock).mockReturnValue({ pathname: '/notes/non-existent' });
  ...
  it('should handle case when storeActions is undefined during initial load', () => {
    ...
    // Mock params with existing note ID
    (require('react-router-dom').useParams as jest.Mock).mockReturnValue({ noteId: 'note-1' });
